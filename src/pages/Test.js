      ...
      <Carousel style={styles.dark}>
        ...
        <Carousel.Item style={styles.item}>
          <ul>
            ...
            <li><strong>Вакансии: </strong>Были написаны разные вакансии. Теперь происходит автоматическая генерация по шаблонам</li>
        ...
        <Carousel.Item style={styles.item}>
          <ul>
            ...
            <li><strong>Вакансии и резюме: </strong>Поправил изменение пропорциональности контейнера (левая и правая часть от разделяющей линии)</li>
        ...
        <Carousel.Item style={styles.item}>
          <ul>
            <li><strong>Навигация: </strong>Убрано выпадающее меню "Создать вакансию" при наведении мыши на "Вакансии"</li>
            ...
            <li><strong>Общее: </strong>Была проделана работа над адаптацией сайта. Теперь его можно открывать на смартфонах</li>
            <li><strong>Вакансии и резюме: </strong>Упрощены функции рендера тегов и условий</li>
            <li><strong>Меню фильтров: </strong>Теперь перемещается вместе с прокруткой страницы. Сами фильтры скрыты до лучших времен</li>
